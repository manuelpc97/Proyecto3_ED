    ...
    private void bt_crearInstalacionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_crearInstalacionMouseClicked
        try {
            ...
            if (this.cb_Material_coneccion.getSelectedItem().equals("Cobre")) {
                while (Integer.parseInt(this.tf_Ancho_de_banda.getText()) > 100 || Integer.parseInt(this.tf_Ancho_de_banda.getText()) <= 0) {
                ...
                while (Integer.parseInt(this.tf_Ancho_de_banda.getText()) > 10240 || Integer.parseInt(this.tf_Ancho_de_banda.getText()) <= 0) {
